...
const accommodations: Accommodation[] = [
  {
    ...
    description:
      "Modern studio apartment in the heart of KL with easy access to public transport.",
    available: true,
  },
  {
    id: "2",
    ...
    description:
      "Clean and safe hostel dorm perfect for budget travelers and students.",
    available: true,
  },
  {
    id: "3",
    ...
    reviews: 156,
    images: [
      "https://images.unsplash.com/photo-1540518614846-7eded1004032?w=400&h=300&fit=crop",
    ],
    ...
    description:
      "Comfortable private room in family home with delicious local breakfast included.",
    available: true,
  },
  {
    id: "4",
    ...
    description:
      "Stunning luxury apartment with panoramic city views and premium amenities.",
    available: true,
  },
  {
    id: "5",
    ...
    description:
      "Perfect for students with study-friendly environment and affordable rates.",
    available: true,
  },
  {
    id: "6",
    ...
    description:
      "Futuristic capsule hotel experience in the heart of entertainment district.",
    available: true,
  },
];
...
export default function Housing() {
  ...
  const filteredAccommodations = accommodations.filter(
    (acc) => acc.price <= priceFilter && acc.available,
  );
  ...
  return (
    <MobileContainer>
      <div className="bg-gray-50 min-h-screen">
        <MobileHeader title="Housing" onBack={() => setLocation("/")} />
          ...
          <div className="flex justify-between items-center">
            ...
            <div>
              ...
              <p className="text-lg font-bold text-blue-600">
                {affordableAccommodations.length} places
              </p>
            </div>
          </div>
        </div>
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      <span className="text-lg font-bold text-gray-900">
                        RM {accommodation.price.toFixed(2)}
                      </span>
          ...
          {filteredAccommodations.length === 0 && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600">
                No accommodations found within your price range.
              </p>
              <p className="text-sm text-gray-500 mt-1">
                Try adjusting your filters or complete more surveys to earn more
                points!
              </p>
            </div>
          )}
            ...
            <div className="bg-white rounded-lg p-6 max-w-sm w-full">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex justify-between border-t pt-2">
                  ...
                  <span className="font-medium">
                    RM {(availableRM - selectedListing.price).toFixed(2)}
                  </span>
                </div>
              </div>
