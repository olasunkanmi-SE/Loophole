          ...
          const defaultSurveys = [
            {
              ...
              basePoints: 12,
              questions: [],
              schedule: { type: 'weekly' as const, frequency: 1, nextAvailable: new Date(Date.now() - 1000) },
              targeting: { userBehavior: ['new_user'], completedCategories: [], pointsRange: { min: 0, max: 100 } },
              isActive: true,
              multiplier: 1
            },
            {
              ...
              basePoints: 5,
              questions: [],
              schedule: { type: 'daily' as const, frequency: 1, nextAvailable: new Date(Date.now() - 1000) },
              targeting: { userBehavior: ['active_user'], completedCategories: [], pointsRange: { min: 0, max: 200 } },
              isActive: true,
              multiplier: 1
            },
            {
              ...
              basePoints: 10,
              questions: [],
              schedule: { type: 'weekly' as const, frequency: 2, nextAvailable: new Date(Date.now() - 1000) },
              targeting: { userBehavior: ['new_user', 'active_user'], completedCategories: [], pointsRange: { min: 0, max: 150 } },
              isActive: true,
              multiplier: 1
            },
            {
            ...
            },
            {
              ...
              category: 'Health',
              description: 'Questions about your health and wellness routines',
              estimatedTime: '6-8 min',
              basePoints: 15,
              questions: [],
              schedule: { type: 'monthly' as const, frequency: 1, nextAvailable: new Date(Date.now() - 1000) },
              targeting: { userBehavior: ['active_user', 'high_earner'], completedCategories: [], pointsRange: { min: 20, max: 300 } },
              isActive: true,
              multiplier: 1
            }
          ];
