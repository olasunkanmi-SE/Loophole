                  ...
                  <Popup>
                    <div className="text-sm">
                      ...
                      <p className="text-xs text-gray-600">
                        Lat: {bridge.latitude.toFixed(4)}, Lng:{" "}
                        {bridge.longitude.toFixed(4)}
                      </p>
                      {bridge.image_url && (
                        <img
                          src={bridge.image_url}
                          alt={bridge.title}
                          className="max-w-[100px] mt-2 rounded"
                        />
                      )}
                    </div>
                  </Popup>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    type="text"
                    id="bridgeTitle"
                    value={newBridgeTitle}
                    onChange={(e) => setNewBridgeTitle(e.target.value)}
                ...
                <div>
                  ...
                  <textarea
                    id="bridgeNote"
                    value={newBridgeNote}
                    onChange={(e) => setNewBridgeNote(e.target.value)}
                    rows={3}
                    className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                  />
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      id="bridgeLat"
                      value={newBridgeLat}
                      onChange={(e) => setNewBridgeLat(e.target.value)}
                      className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      id="bridgeLng"
                      value={newBridgeLng}
                      onChange={(e) => setNewBridgeLng(e.target.value)}
                      className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                    />
                  </div>
                </div>
